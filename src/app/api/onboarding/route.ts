...
export async function POST(request: NextRequest) {
  ...
  // 2. Emails (no crítico) — DESPUÉS de responder vía after(), fuera del camino
  // crítico del round-trip. El cliente recibe success apenas el lead queda en
  // Supabase; los envíos de Resend ya no suman latencia a la respuesta.
  after(async () => {
